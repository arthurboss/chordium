 ...
 */
export function transformToArtistResults(
 ...
 */
export function transformToGenericResults(
  results: (BasicSearchResult & { url?: string })[]
): Array<BasicSearchResult & { url?: string }> {
  return results.map((result) => ({
    ...result,

export const INCREMENT_DECREMENT_BUTTON_STYLES = {
  ...
  decrementButton: "h-5 w-3 p-0 text-primary hover:text-foreground !hover:bg-transparent flex-shrink-0 transition-colors duration-200 border-none outline-none",
  incrementButton: "h-5 w-3 p-0 text-primary hover:text-foreground !hover:bg-transparent flex-shrink-0 transition-colors duration-200 border-none outline-none",
  resetButton: "h-5 w-5 p-0 text-destructive/50 hover:text-destructive hover:bg-transparent flex-shrink-0 transition-colors duration-200 border-none outline-none",
  ...
  disabledButton: "h-5 w-3 p-0 text-muted-foreground cursor-not-allowed flex-shrink-0 transition-colors duration-200 border-none outline-none",
  disabledResetButton: "h-5 w-5 p-0 text-muted-foreground cursor-not-allowed flex-shrink-0 transition-colors duration-200 border-none outline-none"
} as const;

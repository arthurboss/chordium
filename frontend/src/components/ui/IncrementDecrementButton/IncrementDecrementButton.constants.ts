export const INCREMENT_DECREMENT_BUTTON_STYLES = {
  container: "flex items-center justify-between h-6 w-[100px] sm:w-[110px] bg-card/75 border rounded-md px-1",
  ...
  resetButton: "h-5 w-5 p-0 text-destructive/50 hover:text-destructive hover:bg-transparent flex-shrink-0 transition-colors duration-200",

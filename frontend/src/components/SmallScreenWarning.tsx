...
/**
 * Uses max-[359px]:flex to show only on screens smaller than 360px
 */
const SmallScreenWarning = memo(() => {
  const { t } = useTranslation();

  return (
    <div className="hidden max-[359px]:flex fixed inset-0 z-50 flex items-center justify-center p-4 bg-background">

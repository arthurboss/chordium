...
const MobileControlsBar: React.FC<ChordSheetControlsProps> = ({
  ...
  return (
    <StickyBottomContainer isAtBottom={isAtBottom} mobileOnly expanded={showSongControls} className={autoScroll ? 'flex-row' : ''}>
            ...
            <div className="w-full flex items-end justify-center gap-2 mb-2 transition-all duration-300 ease-in-out animate-in slide-in-from-bottom-2">
              ...
              <div className="flex flex-col items-center justify-end">
                <CapoTransposeLink
                  ...
                  onToggle={() => setCapoTransposeLinked?.(!capoTransposeLinked)}
                  title="Link"
                />
              </div>

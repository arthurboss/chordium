...
describe('ChordProPreview', () => {
  it('renders chords and lyric text in distinct elements/classes', () => {
    ...
    const lyricsLine = container.querySelector('.chord-line');
    expect(lyricsLine?.textContent).toBe('GSaying I Clove you');
  });

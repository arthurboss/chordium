export const INCREMENT_DECREMENT_BUTTON_STYLES = {
  container: "flex items-center justify-between h-8 w-32 bg-background border rounded-lg px-2",
  decrementButton: "h-6 w-4 p-0 text-primary hover:text-foreground hover:bg-transparent flex-shrink-0 transition-colors duration-200",
  incrementButton: "h-6 w-4 p-0 text-primary hover:text-foreground hover:bg-transparent flex-shrink-0 transition-colors duration-200",
  ...
  digit: "h-6 flex items-center justify-center font-medium text-sm text-foreground",
  // Static display styles for complex values (like musical keys)
  staticDisplay: "flex items-center gap-1",
  staticMainText: "font-medium text-sm text-foreground",
  ...
  slideText: "absolute inset-0 flex items-center justify-center font-medium text-sm text-foreground",
  slideTextUp: "animate-in slide-in-from-bottom duration-200",
  slideTextDown: "animate-in slide-in-from-top duration-200",
  disabledButton: "h-6 w-4 p-0 text-muted-foreground cursor-not-allowed flex-shrink-0 transition-colors duration-200",
  disabledResetButton: "h-6 w-6 p-0 text-muted-foreground cursor-not-allowed flex-shrink-0 transition-colors duration-200"
} as const;

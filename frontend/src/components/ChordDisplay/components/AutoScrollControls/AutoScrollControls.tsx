    ...
    <div className='flex flex-col items-start gap-1'>
      ...
      <div className='flex items-center'>
        <PlayButton
          ...
          size={16}
          className={`h-8 w-8 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-0 hover:text-primary ${autoScroll && 'max-w-[2rem] text-primary'}`}
        />

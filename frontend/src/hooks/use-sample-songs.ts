 ...
 */
const loadSampleChordSheets = async (): Promise<ChordSheet[]> => {
...
/**
 * Load sample songs in development mode only
 * @returns Array of Song objects with consistent paths
 */
const loadSampleSongs = async (): Promise<Song[]> => {
...
// Export the loadSampleSongs function for any remaining external usage
export { loadSampleSongs };

...
const ResultCard = ({
  ...
  return (
    <Card className="overflow-hidden cursor-pointer w-full h-12 min-h-0 bg-background hover:bg-primary/5 dark:hover:bg-primary/5 hover:border-primary transition-colors" {...cyAttr(`${result.type}-card-compact-${path}`)}>
      <CardContent

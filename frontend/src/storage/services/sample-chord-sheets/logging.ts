/**
 * Sample chord sheets sexport const logLoadingError = (error: Error): void => {
  console.warn('Sample chord sheets: Failed to load sample chord sheets in development mode:', error);
};ice logging utilities
 */
...
export const logLoadingSuccess = (count: number): void => {
  console.log(`Sample chord sheets: Successfully loaded ${count} sample chord sheets`);
};
